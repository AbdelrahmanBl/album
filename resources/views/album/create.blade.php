        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    > <a href="{{ route('home') }}">{{ __('messages.Albums') }}</a> > <a href="#">{{ __('messages.create') }}</a>
                </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div  class="w-100">
                            ...
                            <div class="custom-form-div d-flex align-items-center">
                                ...
                                <input name="album_name" id="name" class="form-control" type="text">
                            </div>
                            ...
                            <div class="custom-form-div d-flex justify-content-center">
                                <button type="button" onclick="addNewAlbum(this)" class="btn btn-success mt-4">
                                    {{ __('messages.add_new') }}
                                </button>
                            </div>
                        </div>
...
@section('custom-scripts')
    ...
    <script>
        ...
        let storeUrl = "{{ route('album.store') }}"
